...
Last updated: 2026-07-18 07:50 UTC
...
arXiv.org 2025. (cited: 34) [[Paper](https://arxiv.org/abs/2505.21851)]\
May 2025

**FlowMol3: Flow Matching for 3D De Novo Small-Molecule Generation**\
*Ian Dunn, D. Koes*\
arXiv.org 2025. (cited: 20) [[Paper](https://arxiv.org/abs/2508.12629)]\
Aug 2025
...
arXiv.org 2025. (cited: 19) [[Paper](https://arxiv.org/abs/2507.13231)]\
Jul 2025

**DiffRhythm 2: Efficient and High Fidelity Song Generation via Block Flow Matching**\
*Yuepeng Jiang, Huakang Chen, Ziqian Ning, Ji-Cheng Yao, Zerui Han, et al.*\
arXiv 2025. (cited: 15) [[Paper](https://arxiv.org/abs/2510.22950)]\
Oct 2025

**Scalable Generation of Spatial Transcriptomics from Histology Images via Whole-Slide Flow Matching**\
*Tinglin Huang, Tianyu Liu, M. Babadi, Wengong Jin, Rex Ying*\
International Conference on Machine Learning 2025. (cited: 20) [[Paper](https://arxiv.org/abs/2506.05361)]\
Jun 2025

**Exponential Family Variational Flow Matching for Tabular Data Generation**\
*Andr'es Guzm'an-Cordero, Floor Eijkelboom, Jan-Willem van de Meent*\
International Conference on Machine Learning 2025. (cited: 17) [[Paper](https://arxiv.org/abs/2506.05940)]\
Jun 2025

**Flow Matching-Based Autonomous Driving Planning with Advanced Interactive Behavior Modeling**\
*Tianyi Tan, Yinan Zheng, Ruiming Liang, Zexu Wang, Kexin Zheng, et al.*\
arXiv.org 2025. (cited: 23) [[Paper](https://arxiv.org/abs/2510.11083)]\
Oct 2025

**Value Gradient Guidance for Flow Matching Alignment**\
*Zhen Liu, Tim Z. Xiao, Carles Domingo-Enrich, Weiyang Liu, Dinghuai Zhang*\
arXiv.org 2025. (cited: 13) [[Paper](https://arxiv.org/abs/2512.05116)]\
Dec 2025

**FLOWER: A Flow-Matching Solver for Inverse Problems**\
*Mehrsa Pourya, B. Rawas, Michael Unser*\
arXiv.org 2025. (cited: 15) [[Paper](https://arxiv.org/abs/2509.26287)]\
Sep 2025

**NExT-OMNI: Towards Any-to-Any Omnimodal Foundation Models with Discrete Flow Matching**\
*Run Luo, Xiaobo Xia, Lu Wang, Longze Chen, Renke Shan, et al.*\
arXiv.org 2025. (cited: 18) [[Paper](https://arxiv.org/abs/2510.13721)]\
Oct 2025
