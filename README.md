...
A curated list of flow matching papers.
...
*Jason Yim, Andrew M. Campbell, Andrew Y. K. Foong, Michael Gastegger, José Jiménez-Luna, et al.*\
arXiv (Cornell University) 2023. (cited: 20) [[Paper](https://arxiv.org/abs/2310.05297)]\
Oct 2023

**SE(3)-Stochastic Flow Matching for Protein Backbone Generation**\
*Avishek Joey Bose, Tara Akhound-Sadegh, Kilian Fatras, Guillaume Huguet, Jarrid Rector-Brooks, et al.*\
arXiv (Cornell University) 2023. (cited: 14) [[Paper](https://arxiv.org/abs/2310.02391)]\
Oct 2023

**EPiC-ly Fast Particle Cloud Generation with Flow-Matching and Diffusion**\
*Erik Buhmann, Cedric Ewen, Darius A. Faroughy, T. Golling, Gregor Kasieczka, et al.*\
arXiv (Cornell University) 2023. (cited: 13) [[Paper](https://arxiv.org/abs/2310.00049)]\
Oct 2023
...
arXiv (Cornell University) 2024. (cited: 11) [[Paper](https://arxiv.org/abs/2405.14806)]\
May 2024

**CaloChallenge 2022: a community challenge for fast calorimeter simulation**\
*Claudius Krause, M. Faucci Giannelli, Gregor Kasieczka, Neil Benjamin, D. Salamani, et al.*\
arXiv (Cornell University) 2024. (cited: 10) [[Paper](https://arxiv.org/abs/2410.21611)]\
Oct 2024

**Generation and application of sub-kilohertz oscillatory flows in microchannels**\
*Giridar Vishwanathan, Gabriel Juarez*\
Microfluidics and Nanofluidics 2019. (cited: 21) [[Paper](https://arxiv.org/abs/1911.07815)]\
Nov 2019

**StyleFlow: Attribute-conditioned Exploration of StyleGAN-Generated Images using Conditional Continuous Normalizing Flows**\
*Rameen Abdal, Peihao Zhu, Niloy J. Mitra, Peter Wonka*\
ACM Transactions on Graphics 2020. (cited: 376) [[Paper](https://arxiv.org/abs/2008.02401)]\
Aug 2020
...
arXiv (Cornell University) 2020. (cited: 47) [[Paper](https://arxiv.org/abs/2002.04461)]\
Feb 2020
...
Neural Information Processing Systems 2024. (cited: 16) [[Paper](https://arxiv.org/abs/2405.13629)]\
May 2024

**Continuous and Distribution-Free Probabilistic Wind Power Forecasting: A Conditional Normalizing Flow Approach**\
*Honglin Wen, P. Pinson, Jinghuan Ma, Jie Gu, Zhijiang Jin*\
